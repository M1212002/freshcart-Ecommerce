...
<form onSubmit={formik.handleSubmit} className="max-w-lg mx-auto">
  ...
  <button type="submit" className="text-white bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800"> {isLoading ? <i className='fas fa-spinner fa-spin'></i> : "Register"}

  </button>
  <Link to={"/login"}><span className='text-emerald-600 underline ms-5 hover:text-black'>do you have an account ? Login Now</span></Link>
  </form> 
  </div> 
  </>
}
