...
//     let {wishlist , loading , removeFromWishlist , getWishlist , wishlistCount, setwishlistCount,wishlistCheck,addToWishlist} = useContext(WishlistContext)
//     let {addProductToCart,numberItems,setnumberItems,tokenStatus} = useContext(CartContext)
//     const Wishlist = () => {
...
//     useEffect(()=>{
//         console.log("wishlistCount updated:", wishlistCount);
//         getWishlist()
//     },[wishlistCount])
...
//                                     <button onClick={()=>removeFromWish(product.id)} className="mx-auto cursor-pointer font-medium text-red-600 dark:text-red-500 hover:underline block mb-4">Remove</button>
//                                     <button onClick={()=>addToCart(product.id)} className="font-medium block mx-auto text-emerald-600 dark:text-emerald-500 hover:underline">Add To Cart</button>
//                                 </td>
//                             </tr>
//                         ))}
//                     </tbody>
