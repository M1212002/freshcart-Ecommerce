...
export default function Cart() {
  ...
  return (
    ...
    <div>
        ...
        {loading ? <i className='fas fa-spinner fa-spin'></i> : `Total price : ${CartDetails?.totalCartPrice}`}
        </h2>
    ...
    </> : <h1 className='text-3xl text-red-600 font-bold text-center my-8 capitalize'>No products added</h1> }
